...
public class FrmAbrirBDocente extends javax.swing.JDialog {
    AdmDocente adm = AdmDocente.getAdmDocente();
    public FrmAbrirBDocente(java.awt.Frame parent, boolean modal) throws ClassNotFoundException {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblContenido.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Sexo", "Fecha Nac", "Teléfono", "Dirección", " Edad", "Título", "Facultad", "Title 10", "Pago "
            }
        ) {
